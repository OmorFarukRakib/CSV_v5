...
csvFileInput.addEventListener("change", (e) => {
  ...
  if (extension === "csv") {
    Papa.parse(csvFileInput.files[0], {
      ...
      skipEmptyLines: true,
      complete: (results) => {
        var headerFroCSV = results.data[0];
        console.log(headerFroCSV.length);
        console.log(headerFroCSV[0]);
        ...
        $(document).ready(function () {
          ...
          updateSerialNo();
          if (
            headerFroCSV.length != 6 ||
            headerFroCSV[0] != `TrackID` ||
            headerFroCSV[1] != `Device Id` ||
            headerFroCSV[2] != `Device Vendor` ||
            headerFroCSV[3] != `Device Model` ||
            headerFroCSV[4] != `Device Serial` ||
            headerFroCSV[5] != `Memo`
          ) {
    ...
    alert("WRONG FILE. Please Upload a valid CSV file!");
     $("#csvFileInput").val("");
